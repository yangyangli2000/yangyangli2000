...
from datautils.radar_scenes_dataset_generator import Radar_Scenes_Train_Dataset, Radar_Scenes_Validation_Dataset
from datautils.network_validation import validation_metric_for_semantic_segmentation, metrics_confusion_matrix, \
    plot_confusion_matrix, validation_metric_for_semantic_segmentation_and_clustering
from model.pointnet2_sem_seg import get_pointnet2_for_semantic_segmentation_model, get_gmlp_based_pointnet2_for_semantic_segmentation_model, \
    get_external_attention_based_pointnet2_for_semantic_segmentation_model, get_self_attention_based_pointnet2_for_semantic_segmentation_model, get_loss

def parse_args():
    parser = argparse.ArgumentParser('PointNet')
    parser.add_argument('--datapath',           default='/home/jc604393/Desktop/RadarScenes/data',
    ...
    parser.add_argument('--cuda',               default=False, # should be Ture but due the HPC limitaiton just set it to False for now
...
def main(args):
    ...
    if args.model_configuration == 'Pointnet2_for_Semantic_Segmentation':
        ...
        semantic_segmentor = get_self_attention_based_pointnet2_for_semantic_segmentation_model(args.numclasses, args.dataset_D, args.dataset_C,
                                      args.first_layer_npoint, args.first_layer_radius, args.first_layer_nsample,
                                      args.second_layer_npoint, args.second_layer_radius, args.second_layer_nsample,
                                      args.turn_on_light_weighted_network_model_using_group_conv)
